...
export default function FileUpload() {
  ...
  const { setValue, register, formState: { errors }, clearErrors } = useFormContext();
          ...
          <div className="relative ml-2 group">
            <span className="cursor-help text-blue-500">ⓘ
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 w-64 bg-gray-800 text-white text-xs rounded p-2 hidden group-hover:block z-10">
                Accepted formats: JPG, PNG, HEIC<br />
                Maximum size: 5MB<br />
                Make sure all text is clearly readable<br />
        ...
        {filePreview ? (
          ...
          <div>
            <svg className="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
              <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4h-8m-12 0H8m12 0a4 4 0 01-4-4m4 4a4 4 0 004 4m0-4v-4m-4-4l4-4m0 0l4 4m-4-4v12" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
      ...
      {errors.id_image_url && (
        <div className="bg-red-50 border border-red-200 rounded-md p-3 mt-3">
          <p className="form-error font-medium flex items-center">
            ...
            {errors.id_image_url.message?.toString() || "ID document is required for merchant accounts"}
          </p>
        </div>
      )}
