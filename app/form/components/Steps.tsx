...
export const PersonalInfoStep: React.FC<StepProps> = ({ currentStep, setCurrentStep }) => {
  const { register, formState: { errors }, trigger, watch, setValue } = useFormContext<SignupFormData>();
...
export const AccountTypeStep: React.FC<StepProps> = ({ currentStep, setCurrentStep }) => {
  const { setValue, formState: { errors }, clearErrors } = useFormContext<SignupFormData>();
  ...
  return (
    <div>
      ...
      {errors.account_type && <p className="form-error">{errors.account_type.message}</p>}
...
export const TermsStep: React.FC<StepProps> = ({ currentStep, setCurrentStep }) => {
  const { register, formState: { errors }, watch, setValue, trigger, handleSubmit } = useFormContext<SignupFormData>();
  ...
  return (
    <div className="bg-white rounded-lg">
      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-6 max-h-60 overflow-y-auto text-sm border border-blue-100 shadow-sm">
        <p className="font-medium text-gray-800 mb-4">By checking the box below, you agree to our Terms of Service and Privacy Policy.</p>
        ...
        <ul className="list-disc ml-5 space-y-2 text-gray-700">
          ...
          <li>For merchant accounts, you agree to comply with all applicable laws and regulations related to payment processing.</li>
          <li>Flash may update these terms from time to time. You will be notified of any significant changes.</li>
        </ul>
        <div className="mt-4 pt-4 border-t border-blue-200">
          <p className="text-gray-700">
            For the complete terms, please visit our <a href="#" className="text-blue-600 hover:underline">Terms of Service</a> and <a href="#" className="text-blue-600 hover:underline">Privacy Policy</a>.
          </p>
        </div>
      </div>
        ...
        <label className="flex items-start cursor-pointer group">
          <div className="relative flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor="terms_accepted" className="font-medium text-gray-700 cursor-pointer group-hover:text-gray-900">
                I agree to the Terms of Service and Privacy Policy<span className="text-red-500 ml-1">*</span>
              </label>
